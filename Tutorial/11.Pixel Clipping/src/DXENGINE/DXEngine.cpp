...
// Descirbe the Sample State
	hr = D3DX11CreateShaderResourceViewFromFile( this->m_D3D11Device, this->Image, NULL, NULL, &(this->m_CubesTexture), NULL );
	if ( FAILED( hr ) )
	{
...
// No Backface Culling
	...
	this->m_D3D11Device->CreateRasterizerState( &rastDesc, &(this->m_NoCull) );
...
// Texture
	...
	this->m_D3D11DevCon->RSSetState( this->m_NoCull );
